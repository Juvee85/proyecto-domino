...
/**
 * Filtra los eventos que provienen del BUS para solo dejar pasar los permitidos
 * por un filtro de estado.
 *
 * @author Saul Neri
 */
public class FiltroEventos {
    ...
    private void permitirSolamenteEventos(List<String> eventosPermitidos) {
        if (eventosPermitidos == null || eventosPermitidos.isEmpty()) {
            return;
        }
