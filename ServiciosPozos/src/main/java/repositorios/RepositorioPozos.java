...
public class RepositorioPozos {
    ...
    /**
     * Crea un nuevo pozo asociado a una sala. Si la sala ya tiene un pozo,
     * lanza una excepción. También asigna 4 fichas a cada jugador de la sala
     * desde el nuevo pozo.
     *
    ...
    /**
     * Elimina el pozo asociado a una sala si existe. Si no existe un pozo para
     * la sala, lanza una excepción.
     *
    ...
    /**
     * Reinicia el pozo asociado a una sala, reemplazándolo por uno nuevo. Si no
     * existe un pozo para la sala, lanza una excepción.
     *
    ...
    /**
     * Obtiene el pozo asociado a una sala. Si no existe un pozo para la sala,
     * lanza una excepción.
     *
    ...
    /**
     * Devuelve fichas de un jugador al pozo de la sala indicada. Si el jugador
     * no tiene fichas para devolver, lanza una excepción.
     *
    ...
    /**
     * Distribuye 4 fichas a cada jugador de una sala desde su pozo. Si no hay
     * jugadores en la sala o no existe el pozo, lanza una excepción.
     *
     * @param sala la sala para la cual se distribuirán las fichas
     * @return una lista de listas de fichas asignadas a cada jugador
     * @throws RepositorioPozoException si no hay jugadores en la sala o no
     * existe el pozo
     */
     ...
     */
    public Ficha obtenerFicha(String nombreSala) throws RepositorioPozoException {
        Sala sala = new Sala();
        sala.setNombre(nombreSala);
        
        Pozo pozo = this.obtenerPozo(sala);
